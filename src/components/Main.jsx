    ...
    <>
      <div>
        <form className='m-4'>
          ...
          <button
            className="text-black bg-yellow-400 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium m-2 rounded-lg text-xl p-2 text-center dark:bg-yellow-400 dark:hover:bg-yellow-300 dark:focus:ring-yellow-300"onClick={reset}
          >
          Reset
          </button>
          </div>
