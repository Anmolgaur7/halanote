    ...
    return (
        <>
            <div className='bg-black'>
                ...
                <p className='text-center text-2xl font-mono text-yellow-300'>Halanote which means "Go note" is note  taking application which can be used to store your importants notes on the cloud.Traditional text docs are great for writing, but thinking requires something more.But halanote provide better ui and mainly u can access your notes from any where.</p>
